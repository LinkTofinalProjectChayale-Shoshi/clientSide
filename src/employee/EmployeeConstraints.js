...
const EmployeeConstraints = (props) => {
                ...
                <ThemeProvider theme={theme}>
                    <div className="flex">
                        <FormControl variant="standard" sx={{ m: 1, minWidth: 120, }} >
                            ...
                            <Select sx={{ color: "rgb(10,108,109)" }} labelId="demo-simple-select-filled-label" defaultValue={props.props.idcity} value={props.props.idcity}
                                onChange={(val) => { dis(addConstarin(val.target.value, "citywork")) }} >
                                {arrCities.map(item =>
                                    <MenuItem sx={{ color: "rgb(10,108,109)" }} key={item.id} value={item.id} >{item.value}</MenuItem>
                                )}
                            </Select>
                    ...
                    <FormControl>
                        ...
                        <div className="flex">
                            ...
                            >
                                <FormControlLabel value="זכר"  control={<Radio />} label="זכר" onChange={(val) => { dis(addConstarin(val.target.value, "gender")) }} />
                                <FormControlLabel value="נקבה" control={<Radio />} label="נקבה" onChange={(val) => { dis(addConstarin(val.target.value, "gender")) }} />
                        ...
                        <div className="flex mr-s">
                            <FormControl variant="standard" sx={{ m: 1, minWidth: 120, }} >
                                ...
                                <Select sx={{ color: "rgb(10,108,109)" }} labelId="demo-simple-select-filled-label" value={props.props.languagefw}
                        ...
                        <TextField
                            id="standard-number"  value={props.props.money_of_hour} sx={{ color: "rgb(10,108,109)", input: { color: 'rgb(10,108,109)' } }} label="מספר מחיר לשעה" type="number" InputLabelProps={{
                                shrink: true,
                            }}
                        ...
                        />
                        <TextField
                            id="standard-number" value={props.props.age_of_o} sx={{ color: "rgb(10,108,109)", input: { color: 'rgb(10,108,109)' } }} label="גיל זקן" type="number" InputLabelProps={{
                                shrink: true,
                            }}
                    ...
                    <div className="center">
                        ...
                        <Slider sx={{ color: "rgb(10,108,109)" }} aria-label="Default" valueLabelDisplay="auto" defaultValue={props.props.Level_of_functioningfg} onChange={(val) => { dis(addConstarin(val.target.value, "Level_of_functioningfg")) }} />
                    </div>
                </ThemeProvider>
            </CacheProvider>
...
export default connect(null, {addConstarin})(EmployeeConstraints);
