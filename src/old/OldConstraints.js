        ...
        <CacheProvider value={cacheRtl}>
            <ThemeProvider theme={theme}>
                <div className="flex">
                    <FormControl variant="standard" sx={{ m: 1, minWidth: 120, }} >
                        ...
                        <Select sx={{ color: "rgb(10,108,109)" }} labelId="demo-simple-select-filled-label" defaultValue={props.props.idcity} value={props.props.idcity}
                            onChange={(val) => { dis(addConstraintsOld(val.target.value, "idcity")) }} >
                            {arrCities.map(item =>
                ...
                <FormControl>
                    ...
                    <div className="flex mr-s">
                        <FormControl variant="standard" sx={{ m: 1, minWidth: 120, }} >
                            ...
                            <Select sx={{ color: "rgb(10,108,109)" }} labelId="demo-simple-select-filled-label" value={props.props.languageold}
                                onChange={(val) => { dis(addConstraintsOld(val.target.value, "languageold")) }} MenuProps={MenuProps}>
                ...
                <div className="center">
                    ...
                    <Slider defaultValue={props.props.Level_of_functioningo} sx={{ color: "rgb(10,108,109)" }} aria-label="Default" valueLabelDisplay="auto" onChange={(val) => { dis(addConstraintsOld(val.target.value, "Level_of_functioningo")) }} />
                ...
                <div className="flex">
                    <RadioGroup
                        aria-labelledby="demo-radio-buttons-group-label" className="dis"
                        defaultValue={props.props.nationold}
                        name="radio-buttons-group"
                        sx={{ color: "rgb(10,108,109)" }}
                    >
